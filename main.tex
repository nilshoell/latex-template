...
\documentclass[
  ...
  english, % ngerman for (new) German -> (New spelling, important for line breaks in a word)
...
% Better highlighting for inline code using the predefined listing colors
